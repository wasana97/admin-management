...
public class CommonConstants {
	...
	public static final String INDEX_ID_PREFIX = "IN001";
	...
	public static final String QUERY_ID_CREATE_TABLE = "create_admin_table";

	/** Constant for query id of insert admins in EmployeeQuery.xml */
	public static final String QUERY_ID_INSERT_ADMINS = "insert_admin";

	/** Constant for query id of get an admin in EmployeeQuery.xml */
	public static final String QUERY_ID_GET_ADMIN = "admin_by_id";

	/** Constant for query id of get all admins in EmployeeQuery.xml */
	public static final String QUERY_ID_ALL_ADMINS = "all_admins";

	/** Constant for query id of remove a admin in EmployeeQuery.xml */
	public static final String QUERY_ID_REMOVE_ADMIN = "remove_admin";

	/** Constant for query id of update a admin in EmployeeQuery.xml */
	public static final String QUERY_ID_UPDATE_ADMIN = "update_admin";

	/** Constant for query id of get all admin ids in EmployeeQuery.xml */
	public static final String QUERY_ID_GET_INDEX_IDS = "admin_ids";
